...
draw_sprite_ext(sprite_index, image_index, x, y, width / sprite_width, height / sprite_height, 0, c_maroon, alpha);
...
for (var i = 0; i < op_length; i++){
	...
	var _c = "[c_white]";
	if (i == pos) _c = "[c_red]";
	draw_text_scribble(x + op_border, y + op_border + op_space * i, _c + options[i]);
